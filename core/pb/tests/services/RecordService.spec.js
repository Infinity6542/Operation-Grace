...
(0, vitest_1.describe)("RecordService", function () {
    const client = new Client_1.default("test_base_url/");
    const service = new RecordService_1.RecordService(client, "sub=");
    (0, suites_1.crudServiceTestsSuite)(service, "/api/collections/sub%3D/records");
    ...
    (0, vitest_1.describe)("AuthStore sync", function () {
        (0, vitest_1.test)("Should update the AuthStore record model on matching update id and collection", async function () {
            var _a;
            fetchMock.on({
                method: "PATCH",
        ...
        (0, vitest_1.test)("Should not update the AuthStore record model on matching id but mismatched collection", async function () {
            var _a;
            fetchMock.on({
                method: "PATCH",
                url: service.client.buildUrl("/api/collections/sub%3D/records/test123"),
        ...
        (0, vitest_1.test)("Should not update the AuthStore record model on mismatched update id", async function () {
            var _a;
            fetchMock.on({
                method: "PATCH",
                url: service.client.buildUrl("/api/collections/sub%3D/records/test123"),
        ...
        (0, vitest_1.test)("Should delete the AuthStore record model on matching delete id and collection", async function () {
            fetchMock.on({
                method: "DELETE",
                url: service.client.buildUrl("/api/collections/sub%3D/records/test123"),
                replyCode: 204,
        ...
        (0, vitest_1.test)("Should not delete the AuthStore record model on matching delete id but mismatched collection", async function () {
            fetchMock.on({
                method: "DELETE",
                url: service.client.buildUrl("/api/collections/sub%3D/records/test123"),
                replyCode: 204,
        ...
        (0, vitest_1.test)("Should not delete the AuthStore record model on mismatched delete id", async function () {
            fetchMock.on({
                method: "DELETE",
                url: service.client.buildUrl("/api/collections/sub%3D/records/test123"),
                replyCode: 204,
        ...
        (0, vitest_1.test)("Should update the AuthStore record model verified state on matching token data", async function () {
            var _a;
            ...
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
            ...
            vitest_1.assert.isTrue((_a = service.client.authStore.model) === null || _a === void 0 ? void 0 : _a.verified);
        });
        (0, vitest_1.test)("Should not update the AuthStore record model verified state on mismatched token data", async function () {
            var _a;
            const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEyMyIsInR5cGUiOiJhdXRoUmVjb3JkIiwiY29sbGVjdGlvbklkIjoiNDU2In0.c9ZkXkC8rSqkKlpyx3kXt9ID3qYsIoy1Vz3a2m3ly0c";
            fetchMock.on({
                method: "POST",
            ...
            const result = await service.confirmVerification(token);
            vitest_1.assert.isTrue(result);
            vitest_1.assert.isFalse((_a = service.client.authStore.model) === null || _a === void 0 ? void 0 : _a.verified);
        });
        (0, vitest_1.test)("Should delete the AuthStore record model matching the token data", async function () {
            const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEyMyIsInR5cGUiOiJhdXRoUmVjb3JkIiwiY29sbGVjdGlvbklkIjoiNDU2In0.c9ZkXkC8rSqkKlpyx3kXt9ID3qYsIoy1Vz3a2m3ly0c";
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
            ...
            vitest_1.assert.isTrue(result);
            vitest_1.assert.isEmpty(service.client.authStore.token);
        });
        (0, vitest_1.test)("Should not delete the AuthStore record model on mismatched token data", async function () {
            const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjEyMyIsInR5cGUiOiJhdXRoUmVjb3JkIiwiY29sbGVjdGlvbklkIjoiNDU2In0.c9ZkXkC8rSqkKlpyx3kXt9ID3qYsIoy1Vz3a2m3ly0c";
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
            ...
            const result = await service.confirmEmailChange(token, "1234");
            vitest_1.assert.isTrue(result);
            vitest_1.assert.isNotEmpty(service.client.authStore.token);
        });
    });
    // ---------------------------------------------------------------
    // auth tests
    ...
    function authResponseCheck(result, expectedToken, expectedRecord) {
        ...
        vitest_1.assert.deepEqual(result.record, expectedRecord);
        vitest_1.assert.equal(service.client.authStore.token, expectedToken);
        vitest_1.assert.deepEqual(service.client.authStore.model, expectedRecord);
    }
    (0, vitest_1.describe)("listAuthMethods()", function () {
        (0, vitest_1.test)("Should fetch all available authorization methods", async function () {
            const expectedBody = {
            ...
            vitest_1.assert.deepEqual(result, expectedBody);
        });
    });
    (0, vitest_1.describe)("authWithPassword()", function () {
        (0, vitest_1.test)("(legacy) Should authenticate a record by its username/email and password", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
        ...
        (0, vitest_1.test)("Should authenticate a record by its username/email and password", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
                    "/auth-with-password?q1=456",
    ...
    (0, vitest_1.describe)("authWithOAuth2Code()", function () {
        (0, vitest_1.test)("(legacy) Should authenticate with OAuth2 a record by an OAuth2 code", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
        ...
        (0, vitest_1.test)("Should authenticate with OAuth2 a record by an OAuth2 code", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
                    "/auth-with-oauth2?q1=456",
    ...
    (0, vitest_1.describe)("authWithOAuth2()", function () {
        (0, vitest_1.test)("(legacy) Should authenticate with OAuth2 a record using the legacy function overload", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
                    "/auth-with-oauth2?q1=456",
    ...
    (0, vitest_1.describe)("authRefresh()", function () {
        (0, vitest_1.test)("(legacy) Should refresh an authorized record instance", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
                    "/auth-refresh?q1=456",
        ...
        (0, vitest_1.test)("Should refresh an authorized record instance", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
                    "/auth-refresh?q1=456",
    ...
    (0, vitest_1.describe)("requestVerification()", function () {
        (0, vitest_1.test)("(legacy) Should send a password reset request", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
    ...
    (0, vitest_1.describe)("confirmVerification()", function () {
        (0, vitest_1.test)("(legacy) Should confirm a password reset request", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
    ...
    (0, vitest_1.describe)("requestEmailChange()", function () {
        (0, vitest_1.test)("(legacy) Should send an email change request", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
        ...
        (0, vitest_1.test)("Should send an email change request", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
                    "/request-email-change?q1=456",
    ...
    (0, vitest_1.describe)("confirmEmailChange()", function () {
        (0, vitest_1.test)("(legacy) Should confirm an email change request", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
        ...
        (0, vitest_1.test)("Should confirm an email change request", async function () {
            fetchMock.on({
                method: "POST",
                url: service.client.buildUrl(service.baseCollectionPath) +
                    "/confirm-email-change?q1=456",
    ...
    (0, vitest_1.describe)("listExternalAuths()", function () {
        (0, vitest_1.test)("Should send a list external auths request", async function () {
            fetchMock.on({
                method: "GET",
            ...
            vitest_1.assert.equal(result.length, 2);
            vitest_1.assert.equal(result[0].provider, "google");
            vitest_1.assert.equal(result[1].provider, "github");
        });
    });
    (0, vitest_1.describe)("unlinkExternalAuth()", function () {
        (0, vitest_1.test)("Should send a unlinkExternalAuth request", async function () {
            fetchMock.on({
                method: "DELETE",
                url: service.client.buildUrl(service.baseCrudPath) +
                    "/" +
...
//# sourceMappingURL=RecordService.spec.js.map